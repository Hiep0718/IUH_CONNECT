...
import com.iuhconnect.mediaservice.dto.ChatMessageDto;
import com.iuhconnect.mediaservice.model.MessageEntity;
import com.iuhconnect.mediaservice.repository.MessageRepository;
import com.iuhconnect.mediaservice.repository.ConversationRepository;
import com.iuhconnect.mediaservice.service.RealtimeEventService;
import com.iuhconnect.mediaservice.service.AutoReplyService;
import com.iuhconnect.mediaservice.service.ConversationReadModelService;
...
public class ChatMessageKafkaConsumer {
    ...
    private final com.iuhconnect.mediaservice.repository.ChatUserRepository chatUserRepository;
    ...
    public ChatMessageKafkaConsumer(
            ...
            com.iuhconnect.mediaservice.repository.ChatUserRepository chatUserRepository,
    ...
    public void consumeChatMessage(ChatMessageDto message) {
        ...
        try {
            ...
            Optional<com.iuhconnect.mediaservice.model.ConversationEntity> convOpt = 
            ...
            if (convOpt.isPresent() && convOpt.get().getType() == com.iuhconnect.mediaservice.model.ConversationType.GROUP) {
                for (com.iuhconnect.mediaservice.model.GroupMember member : convOpt.get().getMembers()) {
