...
import com.iuhconnect.meetingservice.model.MessageEntity;
import com.iuhconnect.meetingservice.repository.MessageRepository;
import com.iuhconnect.meetingservice.repository.ConversationRepository;
import com.iuhconnect.meetingservice.service.RealtimeEventService;
import com.iuhconnect.meetingservice.service.AutoReplyService;
import com.iuhconnect.meetingservice.service.ConversationReadModelService;
...
public class ChatMessageKafkaConsumer {
    ...
    private final com.iuhconnect.meetingservice.repository.ChatUserRepository chatUserRepository;
    ...
    public ChatMessageKafkaConsumer(
            ...
            com.iuhconnect.meetingservice.repository.ChatUserRepository chatUserRepository,
    ...
    public void consumeChatMessage(ChatMessageDto message) {
        ...
        try {
            ...
            Optional<com.iuhconnect.meetingservice.model.ConversationEntity> convOpt = 
            ...
            if (convOpt.isPresent() && convOpt.get().getType() == com.iuhconnect.meetingservice.model.ConversationType.GROUP) {
                for (com.iuhconnect.meetingservice.model.GroupMember member : convOpt.get().getMembers()) {
